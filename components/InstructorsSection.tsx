...
import { Award, BookOpen, Briefcase, Cpu, Shield, Users, Zap, Star, Target, Globe } from "lucide-react";
  ...
  const instructors = [
    {
      ...
      experience: "10+ anos",
      description: "Ladislau Pereira é um profissional de Redes e Segurança de Informação apaixonado por tecnologia, com uma trajetória marcada por disciplina, resiliência e dedicação constante ao aprendizado.",
      ...
      expertise: ["GNS3", "VPNs", "Automação", "TheHive & Cortex", "Troubleshooting"],
    ...
    },
    {
      ...
      experience: "15+ anos",
      description: "Engenheiro de Telecomunicações e profissional sénior em Tecnologia de Informação, com ampla experiência no planeamento, implementação e gestão de infraestruturas de comunicação e redes corporativas.",
      ...
      expertise: ["Redes Móveis Celulares", "Virtualização", "Windows Server", "Segurança", "Liderança Técnica"],
          ...
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="circuit" width="100" height="100" patternUnits="userSpaceOnUse">
                <path d="M0,50 L100,50 M50,0 L50,100" stroke="#3b82f6" strokeWidth="1" fill="none"/>
      ...
      <div className="container mx-auto max-w-7xl relative z-10 px-4">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto font-medium leading-relaxed">
            Conheça os especialistas que vão guiar sua jornada rumo à certificação CCNA
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => {
            ...
            return (
              <div key={index} className="bg-white border border-slate-200 rounded-2xl p-6 text-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
          {instructors.map((instructor, index) => (
            ...
            >
              {/* Header do Card */}
              <div className={`relative h-48 bg-gradient-to-r ${instructor.color} overflow-hidden`}>
                {/* Foto do Instrutor */}
                ...
                <div className="absolute top-6 right-6 bg-white/90 backdrop-blur-sm rounded-full px-4 py-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-bold text-slate-900">{instructor.experience}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-16 px-8 pb-8">
                {/* Nome e título */}
                <div className="mb-6">
                  <h3 className="text-2xl font-black text-slate-900 mb-2">{instructor.name}</h3>
                  <p className="text-slate-600 font-medium">{instructor.title}</p>
                </div>
                
                {/* Descrição */}
                <p className="text-slate-700 mb-6 leading-relaxed">{instructor.description}</p>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-2/3">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-3xl md:text-4xl font-black">
                    Metodologia <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Comprovada</span>
                  </h3>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-lg font-bold text-white mb-2">Aprendizado Prático</h4>
                      <p className="text-slate-400">Laboratórios hands-on com equipamentos reais e simuladores profissionais</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-lg font-bold text-white mb-2">Conexão com o Mercado</h4>
                      <p className="text-slate-400">Casos reais e projetos aplicáveis ao dia a dia corporativo</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-lg font-bold text-white mb-2">Suporte Personalizado</h4>
                      <p className="text-slate-400">Acompanhamento individual e resolução de dúvidas em tempo real</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-lg font-bold text-white mb-2">Networking Profissional</h4>
                      <p className="text-slate-400">Acesso a comunidade exclusiva e conexões com o mercado</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:w-1/3">
                <div className="bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl p-8 text-center relative overflow-hidden">
                  <h4 className="text-2xl font-black text-white mb-4">Pronto para aprender com os melhores?</h4>
                  <p className="text-blue-100 mb-6">
                    Sua jornada rumo à certificação CCNA começa aqui
                  </p>
                  <button className="w-full bg-white text-slate-900 font-bold py-4 px-6 rounded-xl hover:bg-slate-100 transition-all duration-300 hover:-translate-y-1 active:scale-95">
                    Quero Minha Vaga
                  </button>
                </div>
              </div>
