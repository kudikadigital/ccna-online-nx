...
export default function TargetAudience({ onOpenModal }: FeaturesProps) {
  const profiles = [
    {
      icon: Users,
      title: "Iniciantes",
    ...
    },
    {
      ...
      title: "Técnicos",
      description:
        "Já é técnico e busca crescer na carreira, aumentando as oportunidades.",
    ...
    },
    {
      ...
      title: "Profissionais",
      description:
        "Deseja trabalhar em NOC, ISPs, Telecom, Suporte e Infraestrutura.",
    ...
    },
    {
      ...
      title: "Estudantes",
      description:
        "É estudante ou recém-formado e busca uma vantagem competitiva no mercado.",
      ...
      <div className="container mx-auto max-w-7xl relative z-10 px-4">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto font-medium leading-relaxed">
            Se você se identifica com algum destes perfis, esta é a formação
            certa para impulsionar sua carreira em redes
          </p>
        </div>
          ...
          {profiles.map((profile, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Ícone com gradiente */}
                <div
                  className={`relative w-20 h-20 rounded-2xl bg-gradient-to-br ${profile.color} p-4 mb-6 group-hover:scale-110 transition-transform duration-500 shadow-lg`}
                >
                ...
                <div className="space-y-3">
                  {profile.features.map((feature, i) => (
                    <div key={i} className="flex items-center gap-3">
                      <div
                        className={`w-6 h-6 rounded-full ${profile.bgColor} flex items-center justify-center`}
                      >
                        <CheckCircle2
                          className="w-3 h-3"
                          style={{
                            color: profile.color.includes("blue")
                              ? "#3b82f6"
                              : profile.color.includes("purple")
                                ? "#8b5cf6"
                                : profile.color.includes("orange")
                                  ? "#f97316"
                                  : "#10b981",
                          }}
                        />
                ...
                <div
                  className={`absolute bottom-0 left-8 right-8 h-1 bg-gradient-to-r ${profile.color} rounded-full opacity-30 group-hover:opacity-100 transition-all duration-500 transform origin-left scale-x-0 group-hover:scale-x-100`}
                ></div>
              </div>
            );
          })}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10">
            ...
            <div className="lg:w-2/3">
              ...
              <p className="text-slate-300 text-lg leading-relaxed mb-8 max-w-3xl">
                Independente do seu nível atual, o CCNA Online do INEFOR foi
                estruturado para levar você do básico ao avançado, com
                metodologia prática e foco total na certificação oficial da
                Cisco.
              </p>
            ...
            <div className="lg:w-1/3">
              <div className="bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl p-8 text-center relative overflow-hidden group">
                ...
                <button
                  onClick={onOpenModal}
                  className="group w-full bg-white text-slate-900 font-bold py-4 px-6 rounded-xl hover:bg-slate-100 transition-all duration-300 hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-3"
                >
