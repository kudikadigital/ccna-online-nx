...
import { Target, Server, Cpu, Shield, Zap, Layers, Globe, Award, ArrowRight, CheckCircle } from "lucide-react";
...
export default function SkillsSection() {
  const skills = [
    ...
    },
    {
      ...
      description: "Configurar switches e roteadores Cisco de forma prática e eficiente",
    ...
    },
    {
      ...
      description: "Trabalhar com endereçamento, sub-redes, VLANs e roteamento avançado",
      ...
      <div className="container mx-auto max-w-7xl relative z-10 px-4">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-400 max-w-3xl mx-auto font-medium leading-relaxed">
            Domine as competências mais requisitadas pelo mercado e transforme sua carreira em redes
          </p>
        </div>
          ...
          {skills.map((skill, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Ícone com efeito */}
                <div className={`relative w-16 h-16 rounded-2xl bg-gradient-to-br ${skill.color} p-4 mb-6 group-hover:scale-110 transition-transform duration-500 shadow-lg`}>
                ...
                {/* Linha decorativa */}
                <div className={`absolute bottom-0 left-8 right-8 h-1 bg-gradient-to-r ${skill.color} rounded-full opacity-30 group-hover:opacity-100 transition-opacity duration-500`}></div>
              </div>
            );
          })}
        </div>
        ...
        <div className="mb-24">
          <div className="flex items-center gap-4 mb-12">
            ...
            <h3 className="text-3xl font-black text-white">
              Jornada de <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Aprendizado</span>
            </h3>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700/50 rounded-3xl p-12 backdrop-blur-sm">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 text-lg">
                      Junte-se aos +500 profissionais que já conquistaram sua certificação CCNA conosco
                    </p>
                  </div>
                </div>
              ...
              <div className="lg:w-1/3">
                <button className="group w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-black text-lg py-5 px-8 rounded-2xl hover:from-blue-500 hover:to-cyan-500 transition-all duration-300 hover:-translate-y-1 active:scale-95 shadow-2xl shadow-blue-500/25 flex items-center justify-center gap-3">
