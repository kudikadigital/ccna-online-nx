  ...
  return (
    <nav className="fixed top-0 w-full z-50 p-4 pointer-events-none">
      <div className="container mx-auto max-w-7xl flex justify-between items-center bg-slate-950/80 backdrop-blur-xl border border-slate-800/50 p-3 md:p-4 rounded-3xl shadow-2xl shadow-black/40 pointer-events-auto">
        ...
        <Link href="/" className="flex items-center gap-3 group focus:outline-none p-1">
        ...
        {/* Navigation Desktop - Links do Header */}
        <div className="hidden md:flex gap-10 text-[11px] font-black uppercase tracking-[0.15em] text-slate-400">
          <a href="#sobre" className="hover:text-blue-400 transition-colors relative group">
            Sobre
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-500 transition-all group-hover:w-full"></span>
          </a>
          <a href="#instrutores" className="hover:text-blue-400 transition-colors relative group">
            Instrutores
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-500 transition-all group-hover:w-full"></span>
          </a>
          <a href="#faq" className="hover:text-blue-400 transition-colors relative group">
            FAQ
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-500 transition-all group-hover:w-full"></span>
          </a>
        </div>
      ...
      `}>
        <div className="flex flex-col gap-6 text-center">
          <a href="#sobre" onClick={() => setIsMenuOpen(false)} className="text-white font-bold text-lg uppercase tracking-widest">Sobre</a>
          <a href="#instrutores" onClick={() => setIsMenuOpen(false)} className="text-white font-bold text-lg uppercase tracking-widest">Instrutores</a>
          <a href="#faq" onClick={() => setIsMenuOpen(false)} className="text-white font-bold text-lg uppercase tracking-widest">FAQ</a>
          <button 
